...
{
    public class ProductManagerTestDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        public ProductManagerTestDataSeedContributor(IRepository<Category, Guid> categoryRepository,
            IRepository<Product, Guid> productRepository, IGuidGenerator guidGenerator)
        {
